...
//
//    //field used for flatening the json
...
//        new org.jsonUtils.utils.JsonUtils().getFlatJsonObject(jsonObject1, "root");
...
//        flatObject = new JsonObject(); //initiating the static variable to store flat values
//        new org.jsonUtils.utils.JsonUtils().getFlatJsonObject(jsonObject2, "root");
...
//                new org.jsonUtils.utils.JsonUtils().getFlatJsonObject(jObj.get(key).getAsJsonObject(), (rootTag + "==>" + key.toLowerCase()));
//            } else if (jObj.get(key).isJsonArray()) {
//                JsonArray tArray = jObj.get(key).getAsJsonArray();
//                if (tArray.get(0).isJsonObject()) {
//                    for (int i = 0; i < tArray.size(); i++) {
//                        new org.jsonUtils.utils.JsonUtils().getFlatJsonObject(tArray.get(i).getAsJsonObject(), (rootTag + "==>" + key.toLowerCase() + "[" + i + "]"));
//                    }
//                } else {
...
//                updatedArray.add(org.jsonUtils.utils.JsonUtils.updateKeys(objectWithKeysToBeUpdated.get(i).getAsJsonObject(), keysMapper));
//            }
//            return updatedArray;
//        }
//        return null;
